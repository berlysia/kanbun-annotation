...
describe('Kaeri value rendering variations', () => {
  const kaeriExpected: Array<{ value: string; unicode: string; label: string }> = [
    { value: 'レ', unicode: '\u3191', label: 're' },
    { value: '一', unicode: '\u3192', label: 'ichi' },
    { value: '二', unicode: '\u3193', label: 'ni' },
    { value: '三', unicode: '\u3194', label: 'san' },
    { value: '四', unicode: '\u3195', label: 'shi' },
    { value: '上', unicode: '\u3196', label: 'jou' },
    { value: '中', unicode: '\u3197', label: 'chuu' },
    { value: '下', unicode: '\u3198', label: 'ge' },
    { value: '甲', unicode: '\u3199', label: 'kou' },
    { value: '乙', unicode: '\u319A', label: 'otsu' },
    { value: '丙', unicode: '\u319B', label: 'hei' },
    { value: '丁', unicode: '\u319C', label: 'tei' },
    { value: '天', unicode: '\u319D', label: 'ten' },
    { value: '地', unicode: '\u319E', label: 'chi' },
    { value: '人', unicode: '\u319F', label: 'jin' },
  ];
